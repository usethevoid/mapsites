...
public class KmlUtils {
     ...
     * 
     * @param input stream to convert
     * @param file name
     * @return the generated feature collection.
     * @throws Exception
     */
    public static FeatureCollection<SimpleFeatureType, SimpleFeature> kmlFile2FeatureCollection( InputStream origInputStream, String fileName ) throws Exception {
        InputStream inputStream = null;
        if (fileName.toLowerCase().endsWith(KMZ_FILE_EXTENSION)) {
            ZipInputStream zis = new ZipInputStream(origInputStream);
